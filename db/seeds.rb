...
User.create!(full_name: "Allie Rowan", user_name: "AlRow1", email: "aileen.s.rowan+1@gmail.com", password: "password", password_confirmation: "password")
